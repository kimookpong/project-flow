...
export function ProjectCard({ project }: ProjectCardProps) {
    ...
    return (
        <Link to={`/projects/${project.id}`}>
            <div className="flex flex-col gap-2 h-full !p-4 bg-white dark:bg-[#1e232d] rounded-2xl border border-gray-100 dark:border-[#282e39] hover:border-[#135bec]/50 transition-all group relative overflow-hidden shadow-sm hover:shadow-md cursor-pointer">
                {/* Top Gradient Border */}
